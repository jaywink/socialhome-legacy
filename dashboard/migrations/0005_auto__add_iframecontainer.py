...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IFrameContainer'
        db.create_table(u'dashboard_iframecontainer', (
        ...
        db.send_create_signal(u'dashboard', ['IFrameContainer'])


    def backwards(self, orm):
        # Deleting model 'IFrameContainer'
        db.delete_table(u'dashboard_iframecontainer')
