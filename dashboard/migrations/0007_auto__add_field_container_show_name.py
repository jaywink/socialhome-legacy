...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.show_name'
        db.add_column(u'dashboard_container', 'show_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.show_name'
        db.delete_column(u'dashboard_container', 'show_name')
